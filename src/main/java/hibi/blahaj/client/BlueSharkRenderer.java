...
public class BlueSharkRenderer implements IItemRenderer {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        (FMLClientHandler.instance().getClient()).renderEngine.bindTexture(TexturesManager.BLUE_SHARK_TEXTURES);
        model.renderAll();
        GL11.glPopMatrix();
    }
}
